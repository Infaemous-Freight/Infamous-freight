...
- [QUICK_REFERENCE.md](QUICK_REFERENCE.md) - Command cheat sheet and common
  tasks
- [CONTRIBUTING.md](CONTRIBUTING.md) - Development guidelines and contribution
  workflow
...
- **Prerequisites**: Node.js 24+, pnpm 9.15.0, Docker, PostgreSQL 16
...
- [packages/shared/src/types.ts](packages/shared/src/types.ts) - Shared
  TypeScript types
- [packages/shared/src/constants.ts](packages/shared/src/constants.ts) -
  Constants and enums
- [packages/shared/src/utils.ts](packages/shared/src/utils.ts) - Utility
  functions
- [packages/shared/src/env.ts](packages/shared/src/env.ts) - Environment
  validation
...
- **Base URL**: `http://localhost:4000/api` (dev),
  `https://api.infamousfreight.com` (prod)
...
- **Changes**: Pagination (limit 50), status codes (204 for updates), error
  codes
...
This index keeps the root clean and points to the active docs under
...
- [apps/api/prisma/schema.prisma](apps/api/prisma/schema.prisma) - Database
  schema

## Testing & Quality

- [docs/TESTING.md](docs/TESTING.md) - Testing guide
- [docs/testing/TESTING_STRATEGY.md](docs/testing/TESTING_STRATEGY.md) - Test
  strategy
