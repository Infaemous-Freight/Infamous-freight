...
| Netlify request identifier | 01KT0BG0KEZPBMQ302RBF6XNX8 |
...
```json
{"status":"ok","timestamp":"2026-06-01T01:06:43.918Z","services":{"database":"connected"}}
```

## Invalid Tracking Body

```json
{"error":"invalid_tracking_number","message":"Tracking number must use the IF-##### format.","requestId":"3cde4543-b5eb-4e69-8dce-804319072014"}
```
