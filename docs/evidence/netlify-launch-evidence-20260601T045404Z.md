...
| Netlify request identifier | 01KT0RGASEA6MECBV1Z9C5YR8N |
...
```json
{"status":"ok","timestamp":"2026-06-01T04:54:06.610Z","services":{"database":"connected"}}
```

## Invalid Tracking Body

```json
{"error":"invalid_tracking_number","message":"Tracking number must use the IF-##### format.","requestId":"e7a6655f-7c19-4112-87af-5ea0eb99f39b"}
```
