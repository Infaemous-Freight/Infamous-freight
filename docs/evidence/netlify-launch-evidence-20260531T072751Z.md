...
| Netlify request identifier | 01KSYEX5N1EJ2WGS6R95VRXA2N |
...
```json
{"status":"ok","timestamp":"2026-05-31T07:27:51.963Z","services":{"database":"connected"}}
```

## Invalid Tracking Body

```json
{"error":"invalid_tracking_number","message":"Tracking number must use the IF-##### format.","requestId":"61341bc5-69f9-40e1-b0c6-ddcc1f94242a"}
```
