...
| Netlify request identifier | 01KSVKBEYT0323ZQ3TGMG0RPGQ |
...
```json
{"status":"ok","timestamp":"2026-05-30T04:47:51.677Z","services":{"database":"connected"}}
```

## Invalid Tracking Body

```json
{"error":"invalid_tracking_number","message":"Tracking number must use the IF-##### format.","requestId":"914e5615-64f3-4e05-9e0b-870f7b8d8547"}
```
